  ...
  return (
    <div className={cn('flex flex-col', className)}>
      {files.map((file, idx) => {
        ...
        const fileSuccess = successes.find((s) => s.name === file.name);
        const isSuccessfullyUploaded = !!fileSuccess;
      ...
      {exceedMaxFiles && (
        <p className="text-sm text-left mt-2 text-destructive">
          You may upload only up to {maxFiles} file{maxFiles > 1 ? 's' : ''}. Please remove{' '}
